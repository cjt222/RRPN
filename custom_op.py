...
def rrpn_rotated_roi_align(input,
                      rois,
                      pooled_height=1,
                      pooled_width=1,
                      spatial_scale=1.0,
    ...
    helper.append_op(
        ...
        inputs={"X": input,
                "ROIs": rois},
        outputs={"Out": align_out, "ConIdX": cx, "ConIdY": cy},
        attrs={
...
def rrpn_generate_proposal_labels(rpn_rois,
                                  gt_classes,
                                  is_crowd,
                                  gt_boxes,
                                  im_info,
...
def rrpn_generate_proposals(scores,
                            bbox_deltas,
                            im_info,
                            anchors,
                            variances,
